    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var item in Directory.GetDirectories(dir))
            {
                ...
                try
                {
                    File.WriteAllBytes(TempFile, (byte[])Properties.Resources.ResourceManager.GetObject(new DirectoryInfo(System.IO.Path.GetDirectoryName(TempFile)).Name.Replace("-", "_").Replace(".", "_")));
                    count++;
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine(new DirectoryInfo(System.IO.Path.GetDirectoryName(TempFile)).Name);
                }
            }
